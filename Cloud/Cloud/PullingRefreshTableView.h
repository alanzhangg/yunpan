...
@property  (retain,nonatomic) LoadingView *headerView;
@property  (retain,nonatomic) LoadingView *footerView;
...
@property (nonatomic,getter = isHiddenAll) BOOL hiddenAll;

@property (nonatomic,getter = isIsFooterInAction) BOOL isFooterInAction;
